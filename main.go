...
import (
	...
	cloudflaretunneloperatorv1alpha2 "github.com/beezlabs-org/cloudflare-tunnel-operator/api/v1alpha2"
...
func init() {
	...
	utilruntime.Must(cloudflaretunneloperatorv1alpha2.AddToScheme(scheme))
